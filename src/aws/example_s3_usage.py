...
def demonstrate_s3_file_handler():
    ...
    # Example S3 URL
    sqs_to_ml_url = "s3://capstone-development/02f9d020-7883-4b62-99a5-935b44702e62.jpg"
    
    try:
        # Get file info
        print(f"\n📊 Getting file info for: {sqs_to_ml_url}")
        file_info = handler.get_file_info(sqs_to_ml_url)
        ...
        # Download file
        print(f"\n📥 Downloading file...")
        local_path = handler.download_file(sqs_to_ml_url)
