...
class TestModelTrainer:
    ...
    def test_evaluate_models(self, mock_evaluate, mock_set_memory_growth):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            # Mock evaluation
            mock_evaluate.return_value = {'accuracy': 0.8, 'precision': 0.7, 'recall': 0.6, 'f1_score': 0.65, 'specificity': 0.75, 'auc': 0.85, 'sensitivity': 0.6, 'balanced_accuracy': 0.7}
    ...
    def test_print_training_summary(self, mock_set_memory_growth):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            models = {'image': Mock(), 'video': Mock(), 'audio': Mock()}
            evaluation_results = {'accuracy': 0.8, 'precision': 0.7, 'recall': 0.6, 'f1_score': 0.65, 'specificity': 0.75, 'auc': 0.85, 'sensitivity': 0.6, 'balanced_accuracy': 0.7}
...
class TestModelVisualizer:
    ...
    def test_plot_enhanced_model_comparison(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            results = {
                'image_model': {'accuracy': 0.8, 'precision': 0.7, 'recall': 0.6},
                'video_model': {'accuracy': 0.75, 'precision': 0.65, 'recall': 0.55},
                'audio_model': {'accuracy': 0.7, 'precision': 0.6, 'recall': 0.5}
            }
